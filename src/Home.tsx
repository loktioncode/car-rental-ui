            ...
            <div className="container mx-auto space-y-16">
              <section className="grid gap-6 text-center lg:grid-cols-2 xl:grid-cols-5">
                ...
                <img
                  ...
                  alt=""
                  className="object-cover w-full h-full rounded-md xl:col-span-3 dark:bg-coolGray-500"
                ></img>
              </section>
              <section>
                ...
                <h2 className="text-5xl font-bold lg:text-center dark:text-coolGray-50">
                  Building with Mamba is simple
                </h2>
                <div className="grid gap-6 my-16 lg:grid-cols-3">
                  <div className="flex flex-col p-8 space-y-4 rounded-md dark:bg-Gray-600">
                    <div className="flex items-center justify-center flex-shrink-0 w-12 h-12 text-xl font-bold rounded-full dark:bg-violet-400 dark:text-coolGray-900">
                      1
                    </div>
                  ...
                  <div className="flex flex-col p-8 space-y-4 rounded-md https://mam.com/business">
                    <div className="flex items-center justify-center flex-shrink-0 w-12 h-12 text-xl font-bold rounded-full dark:bg-violet-400 dark:text-coolGray-900">
                      2
                    </div>
                    <p className="text-2xl font-semibold">
              ...
              <section className="grid gap-6 lg:grid-cols-2">
                <img
                  ...
                  alt=""
                  className="object-cover w-full rounded-md max-h-96 dark:bg-coolGray-500"
                ></img>
                <div className="flex flex-col items-center w-full p-6 space-y-8 rounded-md lg:h-full lg:p-8 dark:bg-Gray-900">
                  <img
                    src="https://source.unsplash.com/random/100x100"
                    alt=""
                    className="object-cover w-20 h-20 rounded-full dark:bg-coolGray-500"
                  ></img>
                  ...
                  <div className="flex space-x-2">
                    <button
                      type="button"
                      aria-label="Page 1"
                      className="w-2 h-2 rounded-full dark:bg-coolGray-50"
                    ></button>
                    <button
                      type="button"
                      aria-label="Page 2"
                      className="w-2 h-2 rounded-full dark:bg-coolGray-600"
                    ></button>
                    <button
                      type="button"
                      aria-label="Page 3"
